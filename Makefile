...
SOURCES		:=	source
DATA		:=	data
INCLUDES	 := 	include borealis/moonlight_wiliwili/library/include borealis/moonlight_wiliwili/library/lib/extern/nanovg borealis/moonlight_wiliwili/library/lib/extern/yoga borealis/moonlight_wiliwili/library/lib/extern/nanovg/deko3d
ROMFS		:=	romfs
VERSION_MAJOR := 0
VERSION_MINOR := 1
VERSION_MICRO := 0
